...
export default function Biblioteca(){
  ...
  return <main className="digital-store">
    ...
    <section className="digital-system-banner" aria-label="ERP Venda+ para comércio, serviços, imóveis e produção">
      <div className="system-banner-copy"><small>ERP COMERCIAL E FISCAL BRASILEIRO</small><h2>Vendas, atendimento, gestão e nota fiscal em uma única operação.</h2><p>O Venda+ conecta atendimento, pedidos, propostas, clientes, estoque, produção, faturamento e emissão fiscal — do comércio às imobiliárias, serviços e estamparias.</p><a href="/sistemas-jundiai">Conheça o ERP Venda+ <span>→</span></a></div>
      <div className="system-banner-orbit" aria-hidden="true"><div className="system-core"><b>Venda<span>+</span></b><small>gestão integrada</small></div><span className="system-chip chip-orders">Vendas</span><span className="system-chip chip-stock">Estoque</span><span className="system-chip chip-fiscal">NF-e</span><span className="system-chip chip-fashion">Propostas</span><span className="system-chip chip-after">Atendimento</span></div>
      <div className="system-banner-foot"><span><b>Comércio & alimentação</b> atendimento, caixa, pedidos e estoque</span><span><b>Serviços & imóveis</b> clientes, propostas, contratos e cobranças</span><span><b>Moda & produção</b> produtos, artes, etapas e prazos</span></div>
    </section>
