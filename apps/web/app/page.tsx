  ...
  return (
    <div className="public-home">
      ...
      <section className="segment-section" id="segmentos" aria-labelledby="segment-title">
        ...
        <div className="segment-grid"><article><span>01</span><h3>Restaurantes</h3><p>Registre pedidos e acompanhe vendas, produtos e movimentações do dia.</p></article><article><span>02</span><h3>Pizzarias</h3><p>Monte o cardápio por tamanhos, sabores, massas, bordas e adicionais, com regras próprias de preço.</p></article><article><span>03</span><h3>Adegas</h3><p>Controle variedade, quantidade, preços e acesso da equipe em uma única tela.</p></article><article><span>04</span><h3>Lojas</h3><p>Centralize catálogo, caixa, filiais e indicadores para decidir com mais clareza.</p></article><article><span>05</span><h3>Advogados e contratos</h3><small className="segment-status">MÓDULO EM EXPANSÃO</small><p>Organize serviços, responsáveis, recebimentos e acessos conforme o fluxo do escritório.</p></article><article><span>06</span><h3>Consultórios</h3><small className="segment-status">MÓDULO EM EXPANSÃO</small><p>Acompanhe serviços, recebimentos, equipe e unidades em um ambiente centralizado.</p></article><article><span>07</span><h3>Materiais para construção</h3><p>Controle um catálogo amplo, movimentações de estoque, caixa e diferentes usuários.</p></article><article><span>08</span><h3>Locadoras de veículos</h3><small className="segment-status">MÓDULO EM EXPANSÃO</small><p>Adapte cadastros, cobranças, responsáveis e filiais ao processo da sua operação.</p></article><article><span>09</span><h3>Confecção e personalizados</h3><p>Crie peças frente e costas, aplique artes, aprove modelos e transforme a criação em produto.</p></article><article><span>10</span><h3>Imobiliárias e corretores</h3><small className="segment-status">MÓDULO EM EXPANSÃO</small><p>Centralize imóveis, empreendimentos, clientes, corretores, visitas e propostas para acompanhar cada oportunidade até o fechamento.</p></article><article><span>11</span><h3>Estamparias</h3><p>Organize pedidos, artes, produtos, etapas de produção, prazos e entregas em uma operação personalizada.</p></article></div>
      </section>
      <section className="value-section" id="recursos" aria-labelledby="valor-venda-mais">
        ...
        <div className="feature-panels">
          <article role="button" tabIndex={0} data-feature-preview="feature-sale" className={zoomedPreview === "feature-sale" ? "feature-panel-zoomed" : undefined} onClick={() => setZoomedPreview("feature-sale")} onKeyDown={(event) => (event.key === "Enter" || event.key === " ") && setZoomedPreview("feature-sale")}><div className="feature-shot sale-shot"><header><i></i><i></i><i></i><small>PDV · Nova venda</small></header><div><section><span>Original 350ml</span><span>Heineken 350ml</span><span>Água 500ml</span></section><aside><small>VENDA ATUAL</small><p>3 produtos</p><strong>R$ 26,00</strong><em>Finalizar venda</em></aside></div></div><b>01</b><h3>Venda e recebimento</h3><p>PDV ágil, carrinho, formas de pagamento, histórico e baixa automática do estoque.</p></article>
          <article role="button" tabIndex={0} className={zoomedPreview === "feature-panel" ? "feature-panel-zoomed" : undefined} onClick={() => setZoomedPreview("feature-panel")} onKeyDown={(event) => (event.key === "Enter" || event.key === " ") && setZoomedPreview("feature-panel")}><div className="feature-shot panel-shot"><header><i></i><i></i><i></i><small>Visão geral</small></header><div className="shot-metrics"><span><small>Faturamento</small><strong>R$ 28.450</strong></span><span><small>Vendas</small><strong>814</strong></span><span><small>Estoque</small><strong>2.397</strong></span></div><div className="shot-bars"><i></i><i></i><i></i><i></i><i></i><i></i></div></div><b>02</b><h3>Gestão por painéis</h3><p>Faturamento, quantidade de vendas, produtos e estoque reunidos para leitura rápida.</p></article>
          <article role="button" tabIndex={0} className={zoomedPreview === "feature-operation" ? "feature-panel-zoomed" : undefined} onClick={() => setZoomedPreview("feature-operation")} onKeyDown={(event) => (event.key === "Enter" || event.key === " ") && setZoomedPreview("feature-operation")}><div className="feature-shot operation-shot"><header><i></i><i></i><i></i><small>Caixa e operação</small></header><div><span><small>08:00</small><b>Abertura do caixa</b><em>+ R$ 200</em></span><span><small>10:42</small><b>Venda #184</b><em>+ R$ 86</em></span><span><small>13:15</small><b>Retirada registrada</b><em className="negative">− R$ 50</em></span></div></div><b>03</b><h3>Controle operacional</h3><p>Caixa, entradas, retiradas, ajustes, filiais e perfis de acesso separados por responsabilidade.</p></article>
          <article role="button" tabIndex={0} className={zoomedPreview === "feature-access" ? "feature-panel-zoomed" : undefined} onClick={() => setZoomedPreview("feature-access")} onKeyDown={(event) => (event.key === "Enter" || event.key === " ") && setZoomedPreview("feature-access")}><div className="feature-shot access-shot"><header><i></i><i></i><i></i><small>Usuários e permissões</small></header><div><span><i>CG</i><b>Carlos Gomes<small>Administrador</small></b><em>Ativo</em></span><span><i>AM</i><b>Ana Martins<small>Gerente</small></b><em>Ativo</em></span><span><i>JS</i><b>João Silva<small>Caixa</small></b><em>Ativo</em></span></div></div><b>04</b><h3>Acesso seguro</h3><p>Contas individuais, permissões por função, bloqueio administrativo e histórico de alterações.</p></article>
          <article role="button" tabIndex={0} className={zoomedPreview === "feature-support" ? "feature-panel-zoomed" : undefined} onClick={() => setZoomedPreview("feature-support")} onKeyDown={(event) => (event.key === "Enter" || event.key === " ") && setZoomedPreview("feature-support")}><div className="feature-shot support-shot"><header><i></i><i></i><i></i><small>Suporte Venda+ · online</small></header><div><p>Olá! Como podemos ajudar sua operação?</p><p>Preciso conferir o fechamento do caixa.</p><p>Vamos verificar juntos. Envie o número do caixa.</p></div><footer><span>Digite sua dúvida...</span><b>➜</b></footer></div><b>05</b><h3>Suporte 24 horas</h3><p>Acompanhamento contínuo para dúvidas e situações importantes da operação.</p></article>
          <article role="button" tabIndex={0} className={zoomedPreview === "feature-responsive" ? "feature-panel-zoomed" : undefined} onClick={() => setZoomedPreview("feature-responsive")} onKeyDown={(event) => (event.key === "Enter" || event.key === " ") && setZoomedPreview("feature-responsive")}><div className="feature-shot responsive-shot"><header><i></i><i></i><i></i><small>Venda+ responsivo</small></header><div><section><small>Faturamento</small><b>R$ 28.450</b><span></span><span></span><span></span></section><aside><small>Vendas</small><b>814</b><i></i><i></i><i></i></aside></div></div><b>06</b><h3>Em qualquer tela</h3><p>Use pelo computador, tablet ou celular, mantendo as informações centralizadas.</p></article>
        </div>
        {zoomedPreview?.startsWith("feature-") && <button className="preview-close feature-close" onClick={(event) => { event.stopPropagation(); setZoomedPreview(null); }} aria-label="Fechar">×</button>}
      </section>
...
const pagesFor = (roles: string[], segment?: string) => {
  ...
  if (roles.includes("ADMIN")) return ["Visão geral", "Caixa", "PDV", "Estoque", "Produtos", "Clientes", "Venda por QR Code", "E-mail Marketing", "Transcrições de vídeo", ...operations, "Usuários", "Filial", "Configurações", "Fiscal"];
  if (roles.includes("MANAGER")) return ["Visão geral", "Caixa", "PDV", "Estoque", "Produtos", "Clientes", "Venda por QR Code", "E-mail Marketing", "Transcrições de vídeo", ...operations, "Usuários"];
