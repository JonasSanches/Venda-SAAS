...
function GarmentView({ id, template, side, placement }: { id: string; template: Template; side: Side; placement: Placement }) {
  ...
  const shape = shorts
    ? side === "front"
      ? curved
        ? "M110 122 Q250 108 390 122 C396 220 402 330 402 405 Q400 425 370 438 Q320 452 275 445 L250 425 L225 445 Q180 452 130 438 Q100 425 98 405 C98 330 104 220 110 122 Z"
        : "M110 122 Q250 108 390 122 L402 425 Q338 448 275 445 L250 425 L225 445 Q162 448 98 425 Z"
      : curved
        ? "M96 120 Q250 102 404 120 C412 224 418 340 418 415 Q416 438 382 452 Q324 468 276 455 L250 435 L224 455 Q176 468 118 452 Q84 438 82 415 C82 340 88 224 96 120 Z"
        : "M96 120 Q250 102 404 120 L418 438 Q342 464 276 455 L250 435 L224 455 Q158 464 82 438 Z"
    : tank
