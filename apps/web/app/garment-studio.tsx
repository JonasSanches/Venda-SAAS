...
function GarmentView({ id, template, side, placement }: { id: string; template: Template; side: Side; placement: Placement }) {
  ...
  const shape = shorts
    ? side === "front"
      ? curved
        ? "M108 120 Q250 106 392 120 C402 220 418 330 422 400 Q420 424 382 438 Q324 452 275 445 L250 425 L225 445 Q176 452 118 438 Q80 424 78 400 C82 330 98 220 108 120 Z"
        : "M108 120 Q250 106 392 120 L422 420 Q342 448 275 445 L250 425 L225 445 Q158 448 78 420 Z"
      : curved
        ? "M92 118 Q250 100 408 118 C420 224 434 340 438 410 Q436 438 394 452 Q328 468 276 455 L250 435 L224 455 Q172 468 106 452 Q64 438 62 410 C66 340 80 224 92 118 Z"
        : "M92 118 Q250 100 408 118 L438 434 Q346 464 276 455 L250 435 L224 455 Q154 464 62 434 Z"
    : tank
