...
const english: Record<string, string> = {
  ...
  "SISTEMA VENDA+ · FEITO PARA A OPERAÇÃO REAL": "VENDA+ SYSTEM · BUILT FOR REAL OPERATIONS",
  "Seu negócio não para. Sua gestão também não deveria parar.": "Your business never stops. Your management should not either.",
  "Da correria de restaurantes, pizzarias e adegas à criação das empresas de moda e têxtil: uma operação conectada para vender mais e atender melhor.": "From the rush of restaurants, pizzerias and beverage stores to fashion and textile creation: one connected operation to sell more and serve better.",
  "Conhecer o Sistema Venda+": "Discover the Venda+ System",
  "gestão que acompanha": "management that keeps up",
  "Pedidos": "Orders",
  "Nota Fiscal": "Tax invoices",
  "Estamparia": "Print design",
  "Pós-venda": "After-sales",
  "Alimentação": "Food service",
  "atendimento, pedidos e operação de ponta a ponta": "service, orders and end-to-end operations",
  "Moda & Têxtil": "Fashion & textiles",
  "novos modelos, projetos e estamparia": "new designs, projects and print design",
