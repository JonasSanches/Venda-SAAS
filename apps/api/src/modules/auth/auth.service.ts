...
export class AuthService {
  ...
  async createUser(input:{name:string;username:string;password:string;role:"ADMIN"|"MANAGER"|"CASHIER"|"STOCK"}){
    ...
    const permissions={ADMIN:["*"],MANAGER:["sales:*","products:*","inventory:*","cash:*","pizzeria:*"],CASHIER:["sales:create","sales:read","cash:read"],STOCK:["products:read","inventory:*"]}[input.role];
