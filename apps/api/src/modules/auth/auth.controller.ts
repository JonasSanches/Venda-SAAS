...
import { ChangePasswordDto, CreateTenantUserDto, LoginDto, UpdateTenantUserRoleDto } from "./auth.dto";
...
export class AuthController {
  ...
  @Patch("users/:id/role") setUserRole(@Param("id")id:string,@Body()input:UpdateTenantUserRoleDto){return this.auth.setUserRole(id,input.role)}
