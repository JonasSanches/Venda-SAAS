...
export class PartyDto{@IsIn(["CUSTOMER","SUPPLIER"])type!:"CUSTOMER"|"SUPPLIER";@IsString()@MinLength(2)name!:string;@IsOptional()@IsString()@MinLength(11)document?:string;@IsOptional()@IsEmail()email?:string;@IsOptional()@IsString()phone?:string;@IsOptional()@IsString()@MinLength(5)address?:string;@IsOptional()@IsString()@MinLength(2)notes?:string}
