...
class CheckoutDto{@IsOptional()@IsEmail()email?:string}
@Controller("billing")
export class BillingController{
  constructor(private readonly billing:BillingService){}
  @Public()@Get("public/:tenantId")info(@Param("tenantId")tenantId:string){return this.billing.publicInfo(tenantId)}
  @Public()@Post("public/:tenantId/checkout")checkout(@Param("tenantId")tenantId:string,@Body()input:CheckoutDto){return this.billing.checkout(tenantId,input.email)}
