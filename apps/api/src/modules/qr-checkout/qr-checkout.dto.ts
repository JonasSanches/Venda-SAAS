...
import { ArrayMaxSize, ArrayMinSize, IsArray, IsBoolean, IsEmail, IsIn, IsInt, IsOptional, IsString, IsUUID, Length, Min, ValidateNested } from "class-validator";
...
export class StorefrontTemplateDto{@IsIn(["ACAI","SNACKS","SKATE","FRUITS"])template!:"ACAI"|"SNACKS"|"SKATE"|"FRUITS";}
