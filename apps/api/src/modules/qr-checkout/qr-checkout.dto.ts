...
export class LinkDto{@IsString()@Length(2,160)name!:string;@IsBoolean()deliveryEnabled!:boolean;@IsBoolean()addressRequired!:boolean;@IsArray()@ArrayMinSize(1)@ArrayMaxSize(100)@ValidateNested({each:true})@Type(()=>OfferDto)offers!:OfferDto[];}
